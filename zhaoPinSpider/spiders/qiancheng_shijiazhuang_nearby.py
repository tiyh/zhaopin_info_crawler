...
class SubSpider(ZhaopinSpider):
    ...
    name = "qiancheng_shijiazhuang_nearby"
    ...
    start_urls = map(lambda i: r"https://search.51job.com/list/160400%252C160300%252C161100%252C160700%252C160600,000000,0000,00,9,99,%2520,2," \
