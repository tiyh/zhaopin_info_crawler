...
class SubSpider(ZhaopinSpider):
    #name = "qiancheng_nanjing_1_500"
    #name = "qiancheng_nanjing_500_2000"
    name = "qiancheng_nanjing"
    start_urls = map(lambda i: r"https://search.51job.com/list/070200,000000,0000,00,9,99,%2B,2," \
