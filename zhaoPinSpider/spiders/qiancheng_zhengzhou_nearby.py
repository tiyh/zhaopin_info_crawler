...
class SubSpider(ZhaopinSpider):
    ...
    name = "qiancheng_zhengzhou_nearby"
    ...
    start_urls = map(lambda i: r"https://search.51job.com/list/170500%252C170700%252C171100%252C171000%252C170600,000000,0000,00,9,99,%2520,2," \
